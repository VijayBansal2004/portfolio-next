  ...
  return (
    ...
    >
      ...
      >
        ...
        <motion.div
          className="absolute inset-x-0 bottom-0 h-[70%] origin-bottom rounded-lg bg-linear-to-b from-amber-300 to-amber-400 shadow-sm dark:from-amber-400 dark:to-amber-500"
          animate={{
