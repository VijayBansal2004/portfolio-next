...
export const BlogGridCard = ({
  ...
  return (
    <Link href={`/blog/${slug}`}>
      <div
        className={cn(
          "group/feature relative flex h-full flex-col py-5 pt-0 md:border-r md:py-7 dark:border-neutral-800",
      ...
      >
        ...
        <div className="relative z-10 mb-2 px-5 text-lg font-bold md:px-7">
          ...
          <span className="text-vj-primary dark:text-vj-primary-dark sm:text-md inline-block text-sm leading-tight font-bold transition duration-200 group-hover/feature:translate-x-2">
            {title}
          </span>
        </div>
        <div className="relative z-10 mb-2 px-5 text-xs text-neutral-600 md:px-7 dark:text-neutral-400">
          {date}
        </div>

        <Para className="relative z-10 max-w-xs px-5 text-sm md:px-7">
          {description}
        </Para>
      </div>
    </Link>
